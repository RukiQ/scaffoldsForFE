<div class="form-obj">
    ...
    <div class="col first-col">
        ...
        <div class="item">
            <label>组出价：</label>
            <input type="text" class="price price-low"> --
            <input type="text" class="price price-up">&nbsp;元
        </div>
    </div>
    <div class="col second-col">
        ...
        <div class="item">
            <label>开始时间：</label>
            <input type="text" class="calendar time-begin" value="" readonly>
            <label>结束时间：</label>
            <input type="text" class="calendar time-end" value="" readonly>
        </div>
    </div>
    <div class="query">
